...
const transactionIds: string\[\] = \[\"TXN001\", \"TXN002\",
\"TXN003\"\];
...
console.log(\"Transaction ID của phần tử thứ 2:\",
payments\[1\].transactionId);
...
console.log(\"Currency giao dịch cuối cùng:\",
...
console.log(\"Đơn hàng cuối đã thanh toán:\", orders\[orders.length -
1\].paid);
