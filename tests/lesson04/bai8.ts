 ...
 * Điều kiện bắt buộc:
 *  - for...of chỉ xuất hiện MỘT lần
 *  - Không dùng filter / map / reduce / function / any
...
for (const payment of payments) {
    ...
    if (payment.status === SUCCESS) {
        ...
        // Suspicious: amount > 2.000.000 + USD + SUCCESS
    ...
    // Thống kê theo payment method (chỉ biến đếm)
