...
Reusable prompt templates for common QA automation tasks. The agent may reference these when formatting output or when the user's request is unclear.
...
**Element:** [Description of element to locate]
**Page URL:** [URL]
...
```
Analyze flaky test and propose fix:
